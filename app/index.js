	...
	return function($scope, $rootScope, $http, $routeParams, $location, Popup, H, M, S, R) {
		...
		*/
		...
		$scope.initTextResourcesEasy = function(route, singular) {
			...
			// var listTemplate = 'app/config/modules/' + route + '/list.html';
			// var listItemTemplate = 'app/config/modules/' + route + '/list-item.html';
			// var listHeaderTemplate = 'app/config/modules/' + route + '/list-header.html';
			// var listFooterTemplate = 'app/config/modules/' + route + '/list-footer.html';
			// var singleTemplate = 'app/config/modules/' + route + '/single.html';
			// var singleHeaderTemplate = 'app/config/modules/' + route + '/single-header.html';
			// var singleFooterTemplate = 'app/config/modules/' + route + '/single-footer.html';
    ...
    return [
        {
            ...
            showSeparator: false,
            items: [
        	    {action: '', icon: 'home', color: 'gray', text: 'Home'}
	        ],
        ...
        },
        {
            ...
            items: [
        	    ...
        	    {action: 'search', icon: 'search', color: 'brown', text: 'Search'},
        	     ...
        	     {action: 'user_storys', icon: 'list', color: 'brown', text: 'user_story'},
        	     {action: 'profiles', icon: 'assignment', color: 'brown', text: 'profile'},
...
function RegisterRoutes() {
    return {
        ...
        easyRoutes: ['organizations', 'users', 'groups', 'categories', 'tasks','projects','user_storys'], // Provide the names of your tables here and make a copy of app/modules/tasks with the same name
        autoRoutes: ['profiles'], // Either you can provide the names of your tables here, or you can excluded some of the routes below in autoRoutesExcludes
...
//'autoRoutes' and then override the templates using setTemplate function.
//Note that for 'autoRoutes', it is not even required to write Controller Extensions unless you want to modify the behaviour.
app.controller('user_storysControllerExtension', function($scope, $controller, $rootScope, $http, $location, Popup, H, M) {
